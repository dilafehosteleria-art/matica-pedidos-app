...
const ORDER_END_MINUTES = 12 * 60 + 40;
export const ORDER_WINDOW_MESSAGE = "Los pedidos están disponibles de lunes a viernes de 09:30 a 12:40.";
...
export function getOrderWindowState(date = new Date()) {
  ...
  return {
    open,
    message: open ? "Pedidos abiertos hasta las 12:40." : ORDER_WINDOW_MESSAGE
  };
}
